...
export function DrawingCanvas() {
  ...
  const addPoint = useCallback(
    ...
    [points, latestPoint, lines, setLinesDebounced, setPointsDebounced, setLatestPointDebounced]
  );
  ...
  return (
    <div
        id="drawingPad"
        style={{ offset: "50px", height: CANVAS_HEIGHT, width: CANVAS_WIDTH, backgroundColor: "#F0F8FF", opacity: 0.7, position: "absolute", zIndex: 10000 }}
        onClick={addPoint}
      >
        {drawnPoints}
        {drawnLines}
